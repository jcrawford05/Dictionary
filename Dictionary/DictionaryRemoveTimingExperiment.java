...
public class DictionaryRemoveTimingExperiment extends TimingExperiment {
    ...
    private static String toRemove;


    public static void main(String[] args){
        TimingExperiment timingExperiment = new DictionaryRemoveTimingExperiment();
     ...
     */
    public DictionaryRemoveTimingExperiment() {
    ...
    protected void runComputation() {
        dict.removeDefinition(toRemove, 1);
    }
